...
public class DataverseHttpResponse2<D> extends DataverseResponse2<D> {
    private final HttpResponse httpResponse;

    protected DataverseHttpResponse2(HttpResponse httpResponse, ObjectMapper customMapper, Class<?>... dataClass) throws IOException {
